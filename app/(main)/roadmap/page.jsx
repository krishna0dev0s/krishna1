...
import { ArrowLeft, Play, RotateCcw, Loader2, X } from "lucide-react";
    ...
    <div className="w-full min-h-screen pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-bold">Interactive Roadmap Flowchart</h2>
              <p className="text-gray-400">
                Visualize the complete frontend path with zoom, search, and status tracking.
              </p>
            </div>
          </div>
          ...
          {showHints && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -12 }}
            >
              <Card className="bg-gradient-to-r from-blue-50/5 to-purple-50/5 border-blue-500/20">
                <div className="p-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <ul className="text-sm text-gray-300 space-y-1.5 ml-6">
                        <li>• Click any topic to view resources and update status</li>
                        <li>• Use search to jump to a topic instantly</li>
                        <li>• Filter by status to focus on current work</li>
                        <li>• Zoom and pan to explore the full roadmap</li>
                        <li>• Toggle layout between vertical and horizontal views</li>
                      </ul>
                    </div>
                    <Button
                      variant="ghost"
          ...
          <Card className="p-0 overflow-hidden shadow-2xl h-[900px] border-white/10">
            <RoadmapFlowchart
