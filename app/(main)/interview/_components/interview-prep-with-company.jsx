...
import DynamicVoiceInterview from "./dynamic-voice-interview";
import EnhancedVoiceInterview from "./enhanced-voice-interview";
...
export default function InterviewPrepWithCompany({ company, job, onBack }) {
  ...
  // Voice interview mode - using animated voice interview
