    ...
    <>
      ...
      <MotionComponent
        className={cn(
          ...
          'transform-gpu will-change-transform [transform-style:preserve-3d] [perspective:1200px] transition-transform duration-300',
          className
        )}
        style={{
          borderRadius,
      ...
      >
        ...
        <div
          ...
          style={{
            borderRadius,
            boxShadow:
              'inset 0 1px 0 rgba(255,255,255,0.35), inset 0 -12px 24px rgba(0,0,0,0.18), 0 18px 40px -24px rgba(0,0,0,0.6)',
        ...
        <div
          className="relative"
          style={{ transform: 'translateZ(8px)', zIndex: 40 }}
        >
          {children}
        </div>
      </MotionComponent>
